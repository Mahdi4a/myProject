        ...
        /***/ (() => {
            ...
            $(document).ready(function () {
                ...
                function GetValueOnChange() {
                    var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.attribute-select';
                ...
                function deleteDiv() {
                    var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.deleteAttributeDiv';
                    var parentClass = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ".row";
                    $(element).click(function (e) {
                        var element = $(this);
                        var parent = element.closest(parentClass);
                        if (parent[0].id !== 'imageTemplate' && parent[0].id !== 'attributeTemplate') parent.remove();
                    });
                }

                function addSelect2() {
                    var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ".tag-select";
                    $(element).select2({
                        dir: "rtl",
                        tags: true
                    });
                ...
                $("#add_product_attribute").click(function (event) {
                    event.preventDefault();
                    var attributesSection = $("#attribute_section"); // let id = attributesSection.children().length;

                    var temp = document.getElementById('attributeTemplate').cloneNode(true);
                    temp.id = "";
                    var elements = temp.querySelectorAll('select,input');
                    var select = temp.querySelectorAll('.select2-container--default');
...
// require('./admin/jquery-ui-1-12-1.min');
// $.widget.bridge('uibutton', $.ui.button)
// require('./admin/bootstrap.bundle.min');
// require('./admin/ajax-raphael.min');
...
// require('./admin/ajax-moment.min');
// require('./admin/daterangepicker');
// require('./admin/bootstrap-datepicker');
// require('./admin/bootstrap3-wysihtml5.all.min');
...
// require('./admin/fastclick.min');
    ...
    __webpack_require__(/*! ./admin/index */ "./resources/js/admin/index.js");
