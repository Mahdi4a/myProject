                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            <li class="dropdown">
                                <a href="index.html#" class="dropdown-toggle nav-stylehead" data-toggle="dropdown"
                            ...
                            <li class="dropdown">
                                <a class="nav-stylehead dropdown-toggle" href="index.html#" data-toggle="dropdown">Pages
                                    <b class="caret"></b>
                                </a>
