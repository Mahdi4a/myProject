            ...
            <div class="deal-leftmk left-side">
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="{{asset('client/images/d2.jpg')}}" alt="">
                    </div>
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="{{asset('client/images/d1.jpg')}}}" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="{{asset('client/images/d4.jpg')}}}" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                        <h3>Tata Salt</h3>
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="{{asset('client/images/d5.jpg')}}}" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="{{asset('client/images/d3.jpg')}}}" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
            ...
            <ul id="flexiselDemo1">
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="{{asset('client/images/s1.jpg')}}}" alt="">
                            </a>
                        </div>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="{{asset('client/images/s4.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="{{asset('client/images/s2.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single2.html">
                                <img src="{{asset('client/images/s3.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="{{asset('client/images/s8.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single2.html">
                                <img src="{{asset('client/images/s6.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="{{asset('client/images/s5.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single2.html">
                                <img src="{{asset('client/images/s9.jpg')}}}" alt="">
                            </a>
                        </div>
                        <div class="product-name-w3l">
                            <h4>
