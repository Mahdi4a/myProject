    ...
    <div class="footer-info w3-agileits-info">
        ...
        <div class="col-sm-2 footer-grids  w3l-socialmk">
            ...
            <div class="social">
                <ul>
                    <li>
                        <a class="icon fb" href="index.html#">
                            <i class="fa fa-facebook"></i>
                        </a>
                    </li>
                    <li>
                        <a class="icon tw" href="index.html#">
                            <i class="fa fa-twitter"></i>
                        </a>
                    </li>
                    <li>
                        <a class="icon gp" href="index.html#">
    ...
    <div class="agile-sometext">
        ...
        <div class="sub-some child-momu">
            ...
            <ul>
                ...
                <li>
                    <img src="{{asset("client/images/pay5.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay1.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay4.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay6.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay3.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay7.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay8.png")}}" alt="">
                </li>
                <li>
                    <img src="{{asset("client/images/pay9.png")}}" alt="">
                </li>
            </ul>
        </div>
        <!-- //payment -->
