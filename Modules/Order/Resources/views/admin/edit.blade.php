@component('main::admin.layouts.content',['title' => 'ویرایش سفارش'])
            ...
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('admin.orders.update' , $order->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{ $errors->has("finalPrice") ? 'has-error' : ''}}">
                            ...
                            {!! $errors->first("finalPrice", '<p class="help-block" style="color:red">:message</p>') !!}
                        </div>
                        ...
                        <div class="form-group {{ $errors->has("tracking_serial") ? 'has-error' : ''}}">
                            ...
                            {!! $errors->first("tracking_serial", '<p class="help-block" style="color:red">:message</p>') !!}
                        </div>
