...
<div class="header-bot">
    @include('main::client.layouts.header')
</div>
<!-- shop locator (popup) -->
...
<!-- //header-bot -->
<!-- navigation -->
@include('main::client.layouts.navigation')
<!-- //navigation -->
<!-- banner -->
@include('main::client.layouts.slider')
<!-- //banner -->
<!---728x90--->
@yield('content')
<!---728x90--->
...
@if($specialOffer ?? true)
    @include("main::client.layouts.specialOffer")
@endif
<div class="footer-top">
    @include('main::client.layouts.topFooter')
</div>
<!-- footer -->
<footer>
    @include('main::client.layouts.footer')
</footer>
<!-- //footer -->
<!-- copyright -->
<div class="copy-right">
    @include('main::client.layouts.copyRight')
</div>
<!-- //copyright -->
